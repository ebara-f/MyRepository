...
***********************************************************************/
#include    "CalibComm.h"
#include	"CalibInspectMultiPlateExt.h"



int CalibInspectMultiPlateExt::CntDataMesCallBackSub(CALIB_MSEBOX* para)
{
	int ret = 0;
	int i = 0;
	CALIB_RESULT result;
...
int CalibInspectMultiPlateExt::ParaOutCallBackSub(void)
{
	int ret = 0;
