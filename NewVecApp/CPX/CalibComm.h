...
#define MACHINECHECK_TXT L"C:\\ProgramData\\Kosakalab\\Kosaka CMM\\Inifiles\\calib\\MachineCheck\\MachineCheck.txt" // 追加(2025.12.9yori)
#define CALSCN_TXT L"C:\\ProgramData\\Kosakalab\\Kosaka CMM\\Inifiles\\calib\\calscn\\calscn.txt" // 追加(2025.12.9yori)
...
public:
	...
	static void BackScanner(CALIB_SCANNER_MSEBOX* para); // 追加(2025.12.11yori)
	static void ReStartScanner(CALIB_SCANNER_MSEBOX* para); // 追加(2025.12.11yori)
	static void ScanDataMesCallBack(CALIB_SCANNER_MSEBOX* para); // 追加(2025.12.4yori)
	static void CloseScanner(); // 変更(2025.12.17yori)
	static void ScannerAlignmentPanelResultCallBack(CALIB_SCANNER_MSEBOX* para); // 追加(2025.12.9yori)
};