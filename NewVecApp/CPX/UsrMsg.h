...
public:
    ...
    const static int WM_ScannerAlignmentPanel_ReultCallBack = WM_USER + 48; // 追加(2025.12.9yori)
    ...
    const static int WM_Initialize_Completed = WM_USER + 54; // イニシャライズ完了(2026.5.28yori)
};