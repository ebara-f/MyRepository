...
{
    /// <summary>
    /// DlgPrgBarSenser.xaml の相互作用ロジック
    /// </summary>
    public partial class DlgPrgBarSenser : Window
    {
        ...
        public DlgPrgBarSenserViewModel vm;
        ...
        /// 初期化処理
        /// </summary>
        public DlgPrgBarSenser()
        {
            InitializeComponent();
            this.DataContext = vm = new DlgPrgBarSenserViewModel(this);
