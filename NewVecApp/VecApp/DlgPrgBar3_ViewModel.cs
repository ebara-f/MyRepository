...
namespace VecApp
{
	...
	/// </summary>
	public partial class DlgPrgBar3_ViewModel : ViewModel
	{
		private DlgPrgBar3 view;
		private CancellationTokenSource cancelTokensource;

		public DlgPrgBar3_ViewModel(DlgPrgBar3 _view)
		{
			view = _view;
		...
		{
			private DlgPrgBar3_ViewModel vm;

			public ProcCancelCommand(DlgPrgBar3_ViewModel _vm)
			{
				vm = _vm;
			}
