...
{
	/// <summary>
	/// DlgPrgBar1のViewModel
	/// </summary>
	public partial class DlgPrgBar1_ViewModel : ViewModel
	{
		private DlgPrgBar1 view;
		private CancellationTokenSource cancelTokensource;

		public DlgPrgBar1_ViewModel(DlgPrgBar1 _view)
		{
			view = _view;
		...
		{
			private DlgPrgBar1_ViewModel vm;

			public ProcCancelCommand(DlgPrgBar1_ViewModel _vm)
			{
				vm = _vm;
			}
