...
namespace VecApp
{
	...
	/// </summary>
	public partial class PrgressBarViewModel : ViewModel
	{
		private PrgressBar view;
		private CancellationTokenSource cancelTokensource;

		public PrgressBarViewModel(PrgressBar _view)
		{
			view = _view;
		...
		{
			private PrgressBarViewModel vm;

			public ProcCancelCommand(PrgressBarViewModel _vm)
			{
				vm = _vm;
			}
