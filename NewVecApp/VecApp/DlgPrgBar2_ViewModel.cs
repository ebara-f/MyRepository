...
{
	/// <summary>
	/// DlgPrgBar2のViewModel
	/// </summary>
	public partial class DlgPrgBar2_ViewModel : ViewModel
	{
		private DlgPrgBar2 view;
		private CancellationTokenSource cancelTokensource;

		public DlgPrgBar2_ViewModel(DlgPrgBar2 _view)
		{
			view = _view;
		...
		{
			private DlgPrgBar2_ViewModel vm;

			public ProcCancelCommand(DlgPrgBar2_ViewModel _vm)
			{
				vm = _vm;
			}
